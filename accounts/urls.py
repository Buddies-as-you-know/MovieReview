...
from accounts.views import (Comment_List_Movie, Comment_List_TV, HomeView,
...
urlpatterns = [
    ...
    path(
        "commnet_list_movie/<int:user_id>/",
        Comment_List_Movie,
        name="comment_list_movie",
    ),
    ...
    path(
        "password_reset/done/", PasswordResetDone.as_view(), name="password_reset_done"
    ),
    path(
